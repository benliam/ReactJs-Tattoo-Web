 ...
 render() {
   return (
       <header className="fixed-top ">
        <div className="navbar"><a className="navbar-brand" href="index.html"> <img className="default" alt="Neoto - Creative Studio Portfolio Template" src={Logo} /><img className="inverted" alt="Neoto - Creative Studio Portfolio Template" src={Logo}/></a><button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar"><span className="toggle-label">Menu</span><span className="toggle-label-close">Close</span><span className="toggle-icon"><span className="line" /><span className="line" /></span></button></div>
        <ul id="nav">
